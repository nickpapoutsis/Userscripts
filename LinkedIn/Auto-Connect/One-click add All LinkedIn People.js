...
(function() {
    ...
    function buttonClickAction() {
        ...
        if (document.getElementsByClassName("js-discover-person-card__action-btn full-width artdeco-button artdeco-button--2").length > 10) {
            var x = document.getElementsByClassName("js-discover-person-card__action-btn full-width artdeco-button artdeco-button--2");
