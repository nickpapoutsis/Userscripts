...
// @copyright        2023, nickpapoutsis (https://openuserjs.org/users/nickpapoutsis)
...
(function() {
    ...
    function createSearchableMovieName(movieName, movieYear) {
    ...
    var movieYear = getMovieYear();
    var searchableMovieName = createSearchableMovieName(movieName, movieYear);
    ...
    if (movieId || searchableMovieName) {
        let services = [
            ...
            { name: "RARBG Index", url: "https://rarbg.best/search?q=", urlParams: "", use: 'name' }
        ];
        ...
        services.forEach(service => {
            ...
            if (identifier) {
                createServiceButton(service.name, service.url, service.urlParams, identifier, container);
            }
        });
    }
